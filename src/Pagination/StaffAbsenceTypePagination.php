 ...
 */
class StaffAbsenceTypePagination extends ReactPaginationManager
{
    public function execute(): ReactPaginationInterface
    {
        ...
        $action->setTitle('Edit')
            ...
            ->setRoute('user_admin__staff_absence_type_edit')
        ...
        $action->setTitle('Delete')
            ...
            ->setRoute('user_admin__staff_absence_type_delete')
